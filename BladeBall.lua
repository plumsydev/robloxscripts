...
showNotification("plumsy.bladeball", "Insert key to open / hide !")
wait(5)
local version = '0.3'
...
library:init("plumsy.dev " ..version, game:GetService("UserInputService").TouchEnabled, game:GetService("CoreGui"))
