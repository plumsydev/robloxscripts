...
showNotification("plumsy.mm2", "C - Change your speed\nG - Silent Aim")
-- [ Services ] --
...
return
   ...
   Services.StarterGui:SetCore("SendNotification", {
Title = 'ESP';
Text = "Enabled: " .. tostring(ESPToggle);
Duration = 3;
})
...
-- [ Binds ] --
Services.ContextActionService:BindAction('SprintBind', EventFunctions.ContextActionService_V, false, Enum.KeyCode.C) -- Change Binds Here
Services.ContextActionService:BindAction('NotifyBind', EventFunctions.ContextActionService_C, false, Enum.KeyCode.V) -- Change Binds Here
Services.ContextActionService:BindAction('ESPBind', EventFunctions.ContextActionService_B, false, Enum.KeyCode.B) -- Change Binds Here
Services.ContextActionService:BindAction('AIMBind', EventFunctions.ContextActionService_G, false, Enum.KeyCode.G)  --Change Binds Here
